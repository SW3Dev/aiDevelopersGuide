...
- `software-30-developer-guide.md`
  - Full guide with context, principles, practical methods, and phased framework.
  - Best for first-time deep reading and strategic planning.

- `software-30-developer-guide-concise.md`
  - Condensed version focused on actionable steps and quick decision loops.
  - Best for day-to-day implementation and team syncs.

- `software-30-developer-guide-abstract.md`
  - High-level abstract of the guide.
  - Best for quick orientation or sharing the core thesis.

- `software-30-knowledge-base.md`
  - Structured, retrieval-oriented knowledge base format.
...
1. Start with `software-30-developer-guide-abstract.md`
2. Read `software-30-developer-guide.md`
3. Keep `software-30-developer-guide-concise.md` as your operational reference
4. Use `software-30-knowledge-base.md` for AI-tool ingestion and retrieval
5. Use `software-30-cheatsheet.html` for visual review and training sessions
